...
/**
 * \ufffd\ufffd\u053c<br>
 * <i>native declaration : KSUserApiStructEx.h:359</i><br>
...
public class CThostFtdcInstrumentField extends StructObject {
	 ...
	 */
	@Field(31) 
	public CThostFtdcInstrumentField MinBuyVolume(int MinBuyVolume) {
		this.io.setIntField(this, 31, MinBuyVolume);
		return this;
	}
	/**
	 * \ufffd\ufffd\u0421\ufffd\ufffd\ufffd\u00b5\ufffd\ufffd\ufffd\u03bb<br>
	 ...
	 */
	@Field(32) 
	public CThostFtdcInstrumentField MinSellVolume(int MinSellVolume) {
		this.io.setIntField(this, 32, MinSellVolume);
		return this;
	}
	/**
	 * \ufffd\ufffd\u053c\ufffd\ufffd\u02b6\ufffd\ufffd<br>
	 * C type : TThostFtdcInstrumentCodeType
	 */
	@Array({31}) 
	@Field(33) 
	public Pointer<Byte > InstrumentCode() {
